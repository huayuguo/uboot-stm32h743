...
static int show_dram_config(void)
{
	...
	debug("\nRAM xiao Configuration:\n");
		debug("%s: show_dram_config start = 0x%llx, size = 0x%llx\n",
		      __func__,
		      (unsigned long long)gd->bd->bi_dram[0].start,
		      (unsigned long long)gd->bd->bi_dram[0].size);
